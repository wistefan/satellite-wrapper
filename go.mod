module wistefan/satellite-wrapper
...
require (
	...
	github.com/fiware/VCVerifier v0.0.0-20230406071531-42b9dba424b5 // indirect
	github.com/fiware/dsba-pdp v0.0.0-20230406105647-9b50cde4026a // indirect
